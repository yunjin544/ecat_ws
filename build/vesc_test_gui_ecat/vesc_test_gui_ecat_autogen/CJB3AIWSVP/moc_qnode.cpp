...
QT_INIT_METAOBJECT const QMetaObject qtros::QNode::staticMetaObject = { {
    &QThread::staticMetaObject,
    qt_meta_stringdata_qtros__QNode.data,
    qt_meta_data_qtros__QNode,
    qt_static_metacall,
    nullptr,
    nullptr
} };
